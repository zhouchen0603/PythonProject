...
inputfile = 'search_control.csv'
outputfile = 'search_control_args.xml'
...
myxml = RestTesterXml(
    "Verifying arguments of /services/search/sid/control (SPL-26133)")
myxml.add_auth()
...
setup = {'#method': 'POST',
         ...
         '#comment': 'Test Setup',
         '#returncode': '201',
         'search': 'search index=_internal | chart count by source',
         '#save': 'sid://sid'}
...
teardown = {'#method': 'DELETE',
            ...
            '#comment': 'Teardown (delete is the same as cancel)',
            '#returncode': '404',

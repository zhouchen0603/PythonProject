...
inputfile = 'search_results.csv'
outputfile = 'search_results_args.xml'
...
myxml = RestTesterXml(
    "Verifying arguments of /services/search/jobs/<search id>/results_preview that will be exposed (SPL-44282)")
myxml.add_auth()
